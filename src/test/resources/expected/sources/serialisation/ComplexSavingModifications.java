...
public final class GeneratedConfigLoader implements ConfigLoader {
	public static final FieldReference<List<List<String[]>>> field = FieldReference.builder(value -> ComplexSavingModifications.field = value, () -> ComplexSavingModifications.field, new GenericType(List.class, new GenericType(List.class, new GenericType(String[].class))), "FIELD")
			.doesSync(true)
			.validator(ValidatorReference.<List<List<String[]>>>builder()
					.messageProvider(ignored -> "Value for 'FIELD' is invalid. Resetting to default value: 'List.of(List.of(new String[]{\"a\", \"b\"}, new String[]{\"c\", \"d\"}), List.of(new String[]{\"e\", \"f\"}, new String[]{\"g\", \"h\"}))'")
					.fallback(true)
					.defaultSupplier(() -> List.of(List.of(new String[]{"a", "b"}, new String[]{"c", "d"}), List.of(new String[]{"e", "f"}, new String[]{"g", "h"})))
					.build())
			.build();
