...
public final class GeneratedConfigLoader implements ConfigLoader {
	...
	public static final FieldReference<BasicSerialisation.Day> enumField = FieldReference.builder(value -> BasicSerialisation.enumField = value, () -> BasicSerialisation.enumField, new GenericType(BasicSerialisation.Day.class), "ENUM_FIELD").doesSync(true).validator(ValidatorReference.<BasicSerialisation.Day>builder().messageProvider(ignored -> "Value for 'ENUM_FIELD' is invalid. Resetting to default value: 'sources.serialisation.BasicSerialisation.Day.MONDAY'").fallback(true).defaultSupplier(() -> sources.serialisation.BasicSerialisation.Day.MONDAY).build()).build();
