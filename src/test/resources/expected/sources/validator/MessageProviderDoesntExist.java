...
public final class GeneratedConfigLoader implements ConfigLoader {
	public static final FieldReference<Integer> field = FieldReference.builder(value -> MessageProviderDoesntExist.field = value, () -> MessageProviderDoesntExist.field, new GenericType(Integer.class), "FIELD")
			.doesSync(true)
			.validator(ValidatorReference.<Integer>builder()
					.messageProvider(ignored -> "nonExistentMessageProvider")
					.fallback(true)
					.defaultSupplier(() -> 42)
					.build())
			.build();
