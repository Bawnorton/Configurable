		...
		for (Element element : elements) {
			...
			if (!existingNames.add(referenceFieldName)) {
				processingEnv.getMessager()
						.printError("Duplicate configurable entry name '%s' found in class '%s'. Each entry must have a unique name.".formatted(configEntryName, element.getEnclosingElement()
